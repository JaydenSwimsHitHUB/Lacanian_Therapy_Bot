...
# ONE-TIME CLEANUP: Clear lockout for testing
try:
    with _get_db_conn(DB_PATH) as conn:
        conn.execute("DELETE FROM user_lockouts WHERE user_id = ?", ("7551522043",))
        conn.commit()
    print("[CLEANUP] Cleared lockout for user 7551522043")
